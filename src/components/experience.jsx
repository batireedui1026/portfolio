...
const Experience = () => {
  return (
    <div className="dark:bg-gray-100 p-20">
      <Tag text="Experience" />
      <p className="text-center pt-5">
        Here is a quick summary of my most recent experiences
      </p>
      <div className="w-[896px] h-72  m-auto flex justify-between border-2 border-inherit border-solid align dark:bg-white rounded-md mt-14">
